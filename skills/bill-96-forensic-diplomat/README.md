# ⚜️ Bill 96 Forensic Diplomat Skill
...
- **Clinical Forensic Auditing**: Systematically check websites, social media, and apps for Bill 96 violations.
- **Linguistic Excellence**: Generates 100% compliant fr-CA (Quebec French) professional output.
- **Conflict De-escalation**: Handles defensive or hostile business responses with professional poise.
- **Legal Mapping**: Direct links to specific articles of the *Charter of the French Language* (Art. 52, 58, 89, etc.).
- **Remediation Strategy**: Transforms audit findings into actionable "Compliance Patches."

## Usage

Once installed, invoke the skill by asking your agent to perform a Bill 96 audit or handle a compliance outreach:
